...
public class BeerRestController {
    ...
    public ResponseEntity<Beer> saveNewBeer(@Valid @RequestBody BeerDto beerDto){
    ...
    public ResponseEntity<Beer> updateBeer(@PathVariable("beerId") UUID beerId, @Valid @RequestBody BeerDto beerDto){
